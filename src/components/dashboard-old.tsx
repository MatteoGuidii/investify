  ...
  return (
    <div className="min-h-screen bg-neo-dark relative overflow-hidden">
      ...
      <div className="relative z-10 px-6 py-8">
        ...
        {/* Goal Cards with Nexacard Styling */}
        {userGoals.length > 0 && (
        ...
        {/* Account Summary with Nexacard Styling */}
        {portfolios.length > 0 && (
          <div className="mt-12">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold mb-6 text-white">Portfolio Performance</h3>
              <div className="grid gap-6">
                {portfolios.map((portfolio) => {
                  ...
                  return (
                    <div key={portfolio.id} className="neo-card p-6">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div className="neo-glass p-4 rounded-xl">
                          <p className="text-gray-400 mb-1">Invested Amount</p>
                          <p className="font-semibold text-white">{formatCurrency(portfolio.invested_amount)}</p>
                        </div>
                        <div className="neo-glass p-4 rounded-xl">
                          <p className="text-gray-400 mb-1">Current Value</p>
                          <p className="font-semibold text-white">{formatCurrency(portfolio.current_value)}</p>
                        </div>
                        <div className="neo-glass p-4 rounded-xl">
                          <p className="text-gray-400 mb-1">Transactions</p>
                          <p className="font-semibold text-white">{portfolio.transactions.length}</p>
                        </div>
                        <div className="neo-glass p-4 rounded-xl">
                          <p className="text-gray-400 mb-1">Growth Data Points</p>
                          <p className="font-semibold text-white">{portfolio.growth_trend.length}</p>
                        </div>
                      </div>
                      </div>
                    </div>
